...
void der_putget_CK_ATTRIBUTE_ARRAY_DATE(void **state) {
    CK_DATE pValue = {.day="01", .month="02", .year="2021"};
    CK_ATTRIBUTE array1[] = {{.type=CKA_START_DATE, .pValue=&pValue, .ulValueLen=sizeof(CK_BBOOL)},};
    CK_ULONG count = sizeof(array1) / sizeof(CK_ATTRIBUTE);
