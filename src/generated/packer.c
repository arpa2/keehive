...
const derwalk C_VerifyUpdate_Return_packer[] = {
DER_PACK_RemotePKCS11_C_VerifyUpdate_Return,
DER_PACK_END
};

const derwalk C_WaitForSlotEvent_Return_packer[] = {
DER_PACK_RemotePKCS11_C_WaitForSlotEvent_Return,
DER_PACK_END
};

const derwalk C_WrapKey_Return_packer[] = {
