...
typedef DER_OVLY_RemotePKCS11_C_VerifyRecoverInit_Call C_VerifyRecoverInit_Call_t;
...
typedef DER_OVLY_RemotePKCS11_C_VerifyRecoverInit_Return C_VerifyRecoverInit_Return_t;
